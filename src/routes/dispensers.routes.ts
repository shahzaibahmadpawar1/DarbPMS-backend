...
import { createDispenser, getAllDispensers, getDispenserBySerialNumber, updateDispenser, deleteDispenser, getDispensersByStation, getLatestSavedDispenser } from '../controllers/dispensers.controller';
...
router.get('/latest-saved', requireCapability('view'), getLatestSavedDispenser);
