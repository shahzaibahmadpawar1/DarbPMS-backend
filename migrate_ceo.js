...
const DATABASE_URL = 'postgresql://postgres:kaiKzO6avegDp8gi@aws-0-us-east-1.pooler.supabase.com:6543/postgres';
...
async function migrate() {
    ...
    try {
        ...
        console.error('Migration failed:', JSON.stringify(error, null, 2), error);
    } finally {
        await client.end();
    }
}
